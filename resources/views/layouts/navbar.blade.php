 <!--**********************************
        ...
        ***********************************-->
        <div class="nav-header">
			<a href="index.html" class="brand-logo my2">
				<img src="{{ asset('images/logo/lms-logo6.png') }}" alt="LMS Logo" style="width: 150px; height: 80px; border-radius: 5px;">
			</a>
												...
												<div class="card-footer px-0 py-2">
													<a href="" class="dropdown-item ai-icon" 
													   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
														<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path fill-rule="evenodd" clip-rule="evenodd" d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
